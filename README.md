...
- 해결시도2: 
	- X 좌표의 최솟값을 찾고, 최솟값 기준 +-10픽셀에서 Y 좌표의 최댓값 최솟값을 찾아 왼쪽 상단, 왼쪽 하단 꼭짓점 찾기
	- X 좌표의 최댓값을 찾고, 최댓값 기준 +-10픽셀에서 Y 좌표의 최댓값 최솟값을 찾아 왼쪽 상단, 왼쪽 하단 꼭짓점 찾기
	- *카메라가 박스를 정방향으로 찍어야 이 방법이 올바르게 작동*
